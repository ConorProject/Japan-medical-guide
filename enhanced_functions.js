...
function generateCleanActionSteps(med) {
    ...
    if (med.status === 'controlled') {
        ...
        if (med.thresholdNumeric && parseFloat(med.thresholdNumeric) > 0 && med.processingDaysMin > 0) {
            steps.push(`<li class="step-item"><div class="step-marker">2</div><div class="step-text">If above ${threshold}: Apply for Import Confirmation Certificate (${med.processingDaysMin}-${med.processingDaysMax} days)</div></li>`);
        ...
        // Final steps: Digital customs process (same for all quantities)
        const nextStep = med.processingDaysMin > 0 ? 4 : 3;
        steps.push(`<li class="step-item"><div class="step-marker">${nextStep}</div><div class="step-text">Complete Visit Japan Web customs form accurately</div></li>`);
        steps.push(`<li class="step-item"><div class="step-marker">${nextStep + 1}</div><div class="step-text">Answer "Yes" to controlled substances question</div></li>`);
        steps.push(`<li class="step-item"><div class="step-marker">${nextStep + 2}</div><div class="step-text">Be prepared for customs inspection</div></li>`);
    }
